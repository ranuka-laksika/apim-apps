...
function renderSuggestion(suggestion, { query, isHighlighted }) {
    ...
    const suffix = (suggestion.type === 'API' || suggestion.type === 'API_PRODUCT')
        ? suggestion.version
        : ((suggestion.apiDisplayName || suggestion.apiName) + ' ' + suggestion.apiVersion);
    const getIcon = (type) => {
        if (type === 'API') {
            return (
                <CustomIcon
